...
public class Mid {
    ...
    private String jinlan;
    private String leixing;
    private String shichang;

    public Mid(String picihao, String pound, String location, String jinlan, String leixing, String shichang) {
    ...
    public String getJinlan() {
        return jinlan;
    }

    public void setJinlan(String jinlan) {
        this.jinlan = jinlan;
    }
